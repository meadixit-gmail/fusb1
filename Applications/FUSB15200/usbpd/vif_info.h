/* Add new device specific defines */
/* Defines whether 1 USB port will be USB4 UFP */
#define PORT_X_USB4_IS_PERIPHERAL 1
#define PORT_A_PORT_LABEL A

#define PORT_A_CONNECTOR_TYPE                        2
#define PORT_A_MANAGED_GUARANTEED_TYPE               1
#define PORT_A_ID_HEADER_CONNECTOR_TYPE              2
#define PORT_A_USB_PD_SUPPORT                        1
#define PORT_A_PD_PORT_TYPE                          4
#define PORT_A_TYPE_C_STATE_MACHINE                  2
...
#define PORT_A_NUM_FIXED_BATTERIES                   0 //0
...
#define PORT_A_TYPE_C_POWER_SOURCE                   0 // note this setting is completely dependent on board, and changing this changes nothing
...
#endif
#define PORT_A_USB_SUSPEND_MAY_BE_CLEARED                        0
...
#define PORT_A_NUM_SRC_PDOS                                      4
#define PORT_A_EPR_SRC_PDOS                                      0
...
#if (CONFIG_ENABLED(EPR))
#define PORT_A_PD_POWER_AS_SINK 140000
#else
#define PORT_A_PD_POWER_AS_SINK 60000
#endif
#define PORT_A_PD_MIN_POWER_AS_SINK 0
#define PORT_A_PD_MIN_SINK_PDP 5000
#define PORT_A_NO_USB_SUSPEND_MAY_BE_SET                     0
#define PORT_A_GIVEBACK_MAY_BE_SET                           0
#define PORT_A_HIGHER_CAPABILITY_SET                         0
#define PORT_A_FR_SWAP_REQD_TYPE_C_CURRENT_AS_INITIAL_SOURCE 0

#define PORT_A_NUM_SNK_PDOS          4
#define PORT_A_EPR_SNK_PDOS          0
#define PORT_A_SNK_PDO_SUPPLY_TYPE_1 0
#define PORT_A_SNK_PDO_VOLTAGE_1     100
#define PORT_A_SNK_PDO_OP_CURRENT_1  300
#define PORT_A_SNK_PDO_SUPPLY_TYPE_2 0
#define PORT_A_SNK_PDO_VOLTAGE_2     180
#define PORT_A_SNK_PDO_OP_CURRENT_2  300
#define PORT_A_SNK_PDO_SUPPLY_TYPE_3 0
#define PORT_A_SNK_PDO_VOLTAGE_3     300
#define PORT_A_SNK_PDO_OP_CURRENT_3  300
#define PORT_A_SNK_PDO_SUPPLY_TYPE_4 0
#define PORT_A_SNK_PDO_VOLTAGE_4     400
#define PORT_A_SNK_PDO_OP_CURRENT_4  300
//pps
...
#define PORT_A_XID_SOP                           6096
#define PORT_A_DATA_CAPABLE_AS_USB_HOST_SOP      0
#define PORT_A_DATA_CAPABLE_AS_USB_DEVICE_SOP    0
#define PORT_A_PRODUCT_TYPE_UFP_SOP              3
#define PORT_A_PRODUCT_TYPE_DFP_SOP              3 //3
#define PORT_A_DFPVDO_USB2_0_CAPABLE             0
#define PORT_A_DFPVDO_USB3_2_CAPABLE             0
#define PORT_A_DFPVDO_USB4_CAPABLE               0
#define PORT_A_UFPVDO_USB_HIGHEST_SPEED          4
#define PORT_A_MODAL_OPERATION_SUPPORTED_SOP     0
#define PORT_A_USB_VID_SOP                       0x1057
...
#define PORT_B_TYPE_C_POWER_SOURCE           0// note this setting is completely dependent on board, and changing this changes nothing
...
#endif
#define PORT_B_USB_SUSPEND_MAY_BE_CLEARED                        0
...
#endif
#define PORT_B_PD_MIN_POWER_AS_SINK 0
#define PORT_B_PD_MIN_SINK_PDP 5000
#define PORT_B_NO_USB_SUSPEND_MAY_BE_SET                     0
#define PORT_B_GIVEBACK_MAY_BE_SET                           0
#define PORT_B_HIGHER_CAPABILITY_SET                         0
#define PORT_B_FR_SWAP_REQD_TYPE_C_CURRENT_AS_INITIAL_SOURCE 0

#define PORT_B_NUM_SNK_PDOS          4
#define PORT_B_EPR_SNK_PDOS          0
#define PORT_B_SNK_PDO_SUPPLY_TYPE_1 0
#define PORT_B_SNK_PDO_VOLTAGE_1     100
#define PORT_B_SNK_PDO_OP_CURRENT_1  300
#define PORT_B_SNK_PDO_SUPPLY_TYPE_2 0
#define PORT_B_SNK_PDO_VOLTAGE_2     180
#define PORT_B_SNK_PDO_OP_CURRENT_2  300
#define PORT_B_SNK_PDO_SUPPLY_TYPE_3 0
#define PORT_B_SNK_PDO_VOLTAGE_3     300
#define PORT_B_SNK_PDO_OP_CURRENT_3  300
#define PORT_B_SNK_PDO_SUPPLY_TYPE_4 0
#define PORT_B_SNK_PDO_VOLTAGE_4     400
#define PORT_B_SNK_PDO_OP_CURRENT_4  300
//pps
...
#define PORT_B_USB_VID_SOP                       0x1057
